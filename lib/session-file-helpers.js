...
var helpers = {
    ...
    operation.attempt(function () {
      fs.readFile(sessionPath, { encoding: options.encoding }, function (err, data) {
        ...
        if (!err) {
          var json;
          try {
            json = options.decode(options.encrypt ? helpers.decrypt(options, data, sessionId) : data);
          } catch (err2) {
            err = err2;
          }
          if (!err) {
  ...
  encrypt: function (options, text, sessionId) {
  ...
  decrypt: function (options, text, sessionId) {
