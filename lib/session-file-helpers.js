...
var helpers = {
  ...
  defaults: function (options) {
    ...
    return {
      ...
      filePattern: options.fileExtension
        ...
        : /\.json$/,
      keyFunction: options.keyFunction || function(s){return s;},
    };
  },
  ...
  encrypt: function (options, data, sessionId) {
    var cipher = crypto.createCipher(helpers.encAlgorithm, options.keyFunction(sessionId));
  ...
  decrypt: function (options, data, sessionId) {
    var decipher = crypto.createDecipher(helpers.encAlgorithm, options.keyFunction(sessionId));
